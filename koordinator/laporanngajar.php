...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="http://localhost/absensiswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href="http://localhost/absensiswa/koordinator/laporan" class="tip-bottom">Guru</a><a href="#" class="current">Laporan Jam Mengajar</a> </div>
    <h1>Laporan Jam Mengajar</h1>
  </div>
