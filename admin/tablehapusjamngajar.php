...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="http://localhost/absensiswa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href="http://localhost/absensiswa/admin/jamngajar" class="top-bottom">Jam Mengajar</a><a href="#" class="current">Hapus</a> </div>
    <h1>Table Jam Mengajar</h1>
  </div>
