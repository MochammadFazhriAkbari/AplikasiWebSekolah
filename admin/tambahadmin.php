<?php
 ...
 <div id="content-header">
   <div id="breadcrumb"> <a href="http://localhost/absensiwa/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
     <a href="http://localhost/absensiwa/admin/admin" class="tip-bottom">Admin</a>
     <a href="http://localhost/absensiwa/admin/add" class="current">Tambah</a> </div>
   <h1>Tambah Admin</h1>
 </div>
